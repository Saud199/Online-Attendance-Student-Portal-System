    ...
    var checker=0;
       ...
       .on("value", function(snapshot) {
           snapshot.forEach(function(childSnapshot) {
                  ...
                  var a = localStorage.getItem('sdepart');
                 ...
                 document.getElementById('offline').innerHTML='';
                  ...
                  ndiv.setAttribute('style',' margin:auto; width:250px; height:200px; padding:20px; overflow:hidden;  border:solid 2px rgb(15 , 215 , 155); display:inline-block; margin:20px; border-radius:15px');
