...
function showdata(){
    ...
    var checker=0;
        ...
        firebase.database().ref("Users").orderByChild("accountType").equalTo("principal")
       .on("value", function(snapshot) {
           snapshot.forEach(function(childSnapshot) {
                 ...
                 if(childSnapshot.val().id==mid){

                 document.getElementById('changename').value=childSnapshot.val().name;
                 document.getElementById('changeaddress').value=childSnapshot.val().principalAddress;
                 document.getElementById('changeno').value=childSnapshot.val().principalPhoneNo;
                 ...
                 +'<b>Addres : '+childSnapshot.val().principalAddress +'</b><br>'+'<b>Phone No : '+childSnapshot.val().principalPhoneNo+'</b><br>';
